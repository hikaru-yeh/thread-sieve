...
from image_ocr_to_markdown import DEFAULT_MODEL, OCR_PROMPT, download_image, fetch_image_urls_with_playwright, load_dotenv
    ...
    for markdown_path in files:
        ...
        try:
            ...
            if image_ocr is None:
                image_ocr = _build_default_ocr_image(api_key=api_key, model=model)
...
def _build_default_ocr_image(*, api_key: str, model: str) -> Callable[[str], str]:
